    ...
    String fetchcropsfromserver() {
        ...
        try {
            ...
            if (response_code == HttpURLConnection.HTTP_OK) {
                ...
                final List<cropdto> lst_dtos = new ArrayList<cropdto>();
                ...
                try {
                    ...
                    while (_keys.hasNext()) {
                        ...
                        while (_dto_obj_keys.hasNext()) {
                            ...
                            if (DBContract.cropsentitytable.CROP_ID.equals(_current_dto_obj_key)) {
                                _currentdto.setcrop_Id(Long.valueOf(_value));
                            } else if (DBContract.cropsentitytable.CROP_NAME.equals(_current_dto_obj_key)) {
                                _currentdto.setcrop_name(_value);
                            } else if (DBContract.cropsentitytable.CROP_STATUS.equals(_current_dto_obj_key)) {
                                _currentdto.setcrop_status(_value);
                            } else if (DBContract.cropsentitytable.CREATED_DATE.equals(_current_dto_obj_key)) {
    ...
    String fetchcropsvarietiesfromserver() {
        ...
        try {
            ...
            if (response_code == HttpURLConnection.HTTP_OK) {
                ...
                final List<cropvarietydto> lst_dtos = new ArrayList<cropvarietydto>();
                ...
                try {
                    ...
                    while (_keys.hasNext()) {
                        ...
                        while (_dto_obj_keys.hasNext()) {
                            ...
                            if (DBContract.cropsvarietiesentitytable.CROP_VARIETY_ID.equals(_current_dto_obj_key)) {
                                _currentdto.setcropvariety_Id(Long.valueOf(_value));
                            } else if (DBContract.cropsvarietiesentitytable.CROP_VARIETY_NAME.equals(_current_dto_obj_key)) {
                                _currentdto.setcropvariety_name(_value);
                            } else if (DBContract.cropsvarietiesentitytable.CROP_VARIETY_STATUS.equals(_current_dto_obj_key)) {
                                _currentdto.setcropvariety_status(_value);
                            } else if (DBContract.cropsvarietiesentitytable.CROP_VARIETY_CROP_ID.equals(_current_dto_obj_key)) {
                                _currentdto.setcropvariety_crop_id(_value);
                            } else if (DBContract.cropsvarietiesentitytable.CROP_VARIETY_MANUFACTURER_ID.equals(_current_dto_obj_key)) {
                                _currentdto.setcropvariety_manufacturer_id(_value);
                            } else if (DBContract.cropsvarietiesentitytable.CREATED_DATE.equals(_current_dto_obj_key)) {
                                _currentdto.setcreated_date(_value);
                            }
    ...
    String fetchmanufacturersfromserver() {
        ...
        try {
            ...
            if (response_code == HttpURLConnection.HTTP_OK) {
                ...
                final List<manufacturerdto> lst_dtos = new ArrayList<manufacturerdto>();
                ...
                try {
                    ...
                    while (_keys.hasNext()) {
                        ...
                        while (_dto_obj_keys.hasNext()) {
                            ...
                            if (DBContract.manufacturersentitytable.MANUFACTURER_ID.equals(_current_dto_obj_key)) {
                                _currentdto.setmanufacturer_Id(Long.valueOf(_value));
                            } else if (DBContract.manufacturersentitytable.MANUFACTURER_NAME.equals(_current_dto_obj_key)) {
                                _currentdto.setmanufacturer_name(_value);
                            } else if (DBContract.manufacturersentitytable.MANUFACTURER_STATUS.equals(_current_dto_obj_key)) {
                                _currentdto.setmanufacturer_status(_value);
                            } else if (DBContract.manufacturersentitytable.CREATED_DATE.equals(_current_dto_obj_key)) {
                                _currentdto.setcreated_date(_value);
                            }
    ...
    String fetchdiseasespestsfromserver() {
        ...
        try {
            ...
            if (response_code == HttpURLConnection.HTTP_OK) {
                ...
                final List<cropdiseasedto> lst_dtos = new ArrayList<cropdiseasedto>();
                ...
                try {
                    ...
                    while (_keys.hasNext()) {
                        ...
                        while (_dto_obj_keys.hasNext()) {
                            ...
                            if (DBContract.cropsdiseasesentitytable.CROP_DISEASE_ID.equals(_current_dto_obj_key)) {
                                _currentdto.setcropdisease_Id(Long.valueOf(_value));
                            } else if (DBContract.cropsdiseasesentitytable.CROP_DISEASE_NAME.equals(_current_dto_obj_key)) {
                                _currentdto.setcropdisease_name(_value);
                            } else if (DBContract.cropsdiseasesentitytable.CROP_DISEASE_CATEGORY.equals(_current_dto_obj_key)) {
                                _currentdto.setcropdisease_category(_value);
                            } else if (DBContract.cropsdiseasesentitytable.CROP_DISEASE_STATUS.equals(_current_dto_obj_key)) {
                                _currentdto.setcropdisease_status(_value);
                            } else if (DBContract.cropsdiseasesentitytable.CREATED_DATE.equals(_current_dto_obj_key)) {
                                _currentdto.setcreated_date(_value);
                            }
    ...
    String fetchcategoriesfromserver() {
        ...
        try {
            ...
            if (response_code == HttpURLConnection.HTTP_OK) {
                ...
                final List<categorydto> lst_dtos = new ArrayList<categorydto>();
                ...
                try {
                    ...
                    while (_keys.hasNext()) {
                        ...
                        while (_dto_obj_keys.hasNext()) {
                            ...
                            if (DBContract.categoriesentitytable.CATEGORY_ID.equals(_current_dto_obj_key)) {
                                _currentdto.setcategory_Id(Long.valueOf(_value));
                            } else if (DBContract.categoriesentitytable.CATEGORY_NAME.equals(_current_dto_obj_key)) {
                                _currentdto.setcategory_name(_value);
                            } else if (DBContract.categoriesentitytable.CATEGORY_STATUS.equals(_current_dto_obj_key)) {
                                _currentdto.setcategory_status(_value);
                            } else if (DBContract.categoriesentitytable.CREATED_DATE.equals(_current_dto_obj_key)) {
                                _currentdto.setcreated_date(_value);
                            }
    ...
    String fetchpestsinsecticidesfromserver() {
        ...
        try {
            ...
            if (response_code == HttpURLConnection.HTTP_OK) {
                ...
                final List<pestinsecticidedto> lst_dtos = new ArrayList<pestinsecticidedto>();
                ...
                try {
                    ...
                    while (_keys.hasNext()) {
                        ...
                        while (_dto_obj_keys.hasNext()) {
                            ...
                            if (DBContract.pestsinsecticidesentitytable.PESTINSECTICIDE_ID.equals(_current_dto_obj_key)) {
                                _currentdto.setpestinsecticide_Id(Long.valueOf(_value));
                            } else if (DBContract.pestsinsecticidesentitytable.PESTINSECTICIDE_NAME.equals(_current_dto_obj_key)) {
                                _currentdto.setpestinsecticide_name(_value);
                            } else if (DBContract.pestsinsecticidesentitytable.PESTINSECTICIDE_CATEGORY.equals(_current_dto_obj_key)) {
                                _currentdto.setpestinsecticide_category(_value);
                            } else if (DBContract.pestsinsecticidesentitytable.PESTINSECTICIDE_STATUS.equals(_current_dto_obj_key)) {
                                _currentdto.setpestinsecticide_status(_value);
                            } else if (DBContract.pestsinsecticidesentitytable.CREATED_DATE.equals(_current_dto_obj_key)) {
                                _currentdto.setcreated_date(_value);
                            } else if (DBContract.pestsinsecticidesentitytable.PESTINSECTICIDE_CROP_DISEASE_ID.equals(_current_dto_obj_key)) {
                                _currentdto.setpestinsecticide_crop_disease_id(_value);
                            } else if (DBContract.pestsinsecticidesentitytable.PESTINSECTICIDE_MANUFACTURER_ID.equals(_current_dto_obj_key)) {
    ...
    String fetchsettingsfromserver() {
        ...
        try {
            ...
            if (response_code == HttpURLConnection.HTTP_OK) {
                ...
                final List<settingdto> lst_dtos = new ArrayList<settingdto>();
                ...
                try {
                    ...
                    while (_keys.hasNext()) {
                        ...
                        while (_dto_obj_keys.hasNext()) {
                            ...
                            if (DBContract.settingsentitytable.SETTING_ID.equals(_current_dto_obj_key)) {
                                _currentdto.setsetting_Id(Long.valueOf(_value));
                            } else if (DBContract.settingsentitytable.SETTING_NAME.equals(_current_dto_obj_key)) {
                                _currentdto.setsetting_name(_value);
                            } else if (DBContract.settingsentitytable.SETTING_VALUE.equals(_current_dto_obj_key)) {
                                _currentdto.setsetting_value(_value);
                            } else if (DBContract.settingsentitytable.SETTING_STATUS.equals(_current_dto_obj_key)) {
                                _currentdto.setsetting_status(_value);
                            } else if (DBContract.settingsentitytable.CREATED_DATE.equals(_current_dto_obj_key)) {
                                _currentdto.setcreated_date(_value);
                            }
