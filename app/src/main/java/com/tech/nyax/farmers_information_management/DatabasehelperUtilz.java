...
//diseases/pests
import static com.tech.nyax.farmers_information_management.DBContract.cropsdiseasesentitytable.CROPS_DISEASES_TABLE_NAME;
import static com.tech.nyax.farmers_information_management.DBContract.cropsdiseasesentitytable.CROP_DISEASE_CATEGORY;
import static com.tech.nyax.farmers_information_management.DBContract.cropsdiseasesentitytable.CROP_DISEASE_ID;
import static com.tech.nyax.farmers_information_management.DBContract.cropsdiseasesentitytable.CROP_DISEASE_NAME;
import static com.tech.nyax.farmers_information_management.DBContract.cropsdiseasesentitytable.CROP_DISEASE_STATUS;
//crops
import static com.tech.nyax.farmers_information_management.DBContract.cropsentitytable.CROPS_TABLE_NAME;
import static com.tech.nyax.farmers_information_management.DBContract.cropsentitytable.CROP_ID;
import static com.tech.nyax.farmers_information_management.DBContract.cropsentitytable.CROP_NAME;
import static com.tech.nyax.farmers_information_management.DBContract.cropsentitytable.CROP_STATUS;
//manufacturers
import static com.tech.nyax.farmers_information_management.DBContract.manufacturersentitytable.MANUFACTURERS_TABLE_NAME;
import static com.tech.nyax.farmers_information_management.DBContract.manufacturersentitytable.MANUFACTURER_ID;
import static com.tech.nyax.farmers_information_management.DBContract.manufacturersentitytable.MANUFACTURER_NAME;
import static com.tech.nyax.farmers_information_management.DBContract.manufacturersentitytable.MANUFACTURER_STATUS;
//pesticides/insecticides
import static com.tech.nyax.farmers_information_management.DBContract.pestsinsecticidesentitytable.PESTINSECTICIDE_CATEGORY;
import static com.tech.nyax.farmers_information_management.DBContract.pestsinsecticidesentitytable.PESTINSECTICIDE_ID;
import static com.tech.nyax.farmers_information_management.DBContract.pestsinsecticidesentitytable.PESTINSECTICIDE_NAME;
import static com.tech.nyax.farmers_information_management.DBContract.pestsinsecticidesentitytable.PESTINSECTICIDE_STATUS;
import static com.tech.nyax.farmers_information_management.DBContract.pestsinsecticidesentitytable.PESTINSECTICIDE_CROP_DISEASE_ID;
import static com.tech.nyax.farmers_information_management.DBContract.pestsinsecticidesentitytable.PESTINSECTICIDE_MANUFACTURER_ID;
import static com.tech.nyax.farmers_information_management.DBContract.pestsinsecticidesentitytable.PESTSINSECTICIDES_TABLE_NAME;
//settings
import static com.tech.nyax.farmers_information_management.DBContract.settingsentitytable.SETTINGS_TABLE_NAME;
import static com.tech.nyax.farmers_information_management.DBContract.settingsentitytable.SETTING_ID;
import static com.tech.nyax.farmers_information_management.DBContract.settingsentitytable.SETTING_NAME;
import static com.tech.nyax.farmers_information_management.DBContract.settingsentitytable.SETTING_STATUS;
import static com.tech.nyax.farmers_information_management.DBContract.settingsentitytable.SETTING_VALUE;
//crops varieties
import static com.tech.nyax.farmers_information_management.DBContract.cropsvarietiesentitytable.CROPS_VARIETIES_TABLE_NAME;
import static com.tech.nyax.farmers_information_management.DBContract.cropsvarietiesentitytable.CROP_VARIETY_ID;
import static com.tech.nyax.farmers_information_management.DBContract.cropsvarietiesentitytable.CROP_VARIETY_NAME;
import static com.tech.nyax.farmers_information_management.DBContract.cropsvarietiesentitytable.CROP_VARIETY_STATUS;
import static com.tech.nyax.farmers_information_management.DBContract.cropsvarietiesentitytable.CROP_VARIETY_CROP_ID;
import static com.tech.nyax.farmers_information_management.DBContract.cropsvarietiesentitytable.CROP_VARIETY_MANUFACTURER_ID;
//categories
import static com.tech.nyax.farmers_information_management.DBContract.categoriesentitytable.CATEGORIES_TABLE_NAME;
import static com.tech.nyax.farmers_information_management.DBContract.categoriesentitytable.CATEGORY_ID;
import static com.tech.nyax.farmers_information_management.DBContract.categoriesentitytable.CATEGORY_NAME;
import static com.tech.nyax.farmers_information_management.DBContract.categoriesentitytable.CATEGORY_STATUS;
...
public class DatabasehelperUtilz extends SQLiteOpenHelper {
    ...
    public static final String packagename = "com.tech.nyax.farmers_information_management";
...
// If moveToFirst() returns false then cursor is empty
            ...
            final List<categorydto> categorydtos = new ArrayList<categorydto>();
            do {
...
// If moveToFirst() returns false then cursor is empty
            if (!cursor.moveToFirst()) {
                return new ArrayList<cropdto>();
            }
            final List<cropdto> cropdtos = new ArrayList<cropdto>();
            do {
// Read the values of a row in the table using the indexes acquired above
                cropdto _cropdto = new cropdto();
...
// If moveToFirst() returns false then cursor is empty
            if (!cursor.moveToFirst()) {
                return new ArrayList<cropdiseasedto>();
            }
            final List<cropdiseasedto> cropdiseasedtos = new ArrayList<cropdiseasedto>();
            do {
// Read the values of a row in the table using the indexes acquired above
                cropdiseasedto _cropdiseasedto = new cropdiseasedto();
...
// If moveToFirst() returns false then cursor is empty
            if (!cursor.moveToFirst()) {
                return new ArrayList<cropvarietydto>();
            }
            final List<cropvarietydto> cropsvarietiesdtos = new ArrayList<cropvarietydto>();
            do {
// Read the values of a row in the table using the indexes acquired above
                cropvarietydto _cropvarietydto = new cropvarietydto();
...
// If moveToFirst() returns false then cursor is empty
            if (!cursor.moveToFirst()) {
                return new ArrayList<manufacturerdto>();
            }
            final List<manufacturerdto> manufacturerdtos = new ArrayList<manufacturerdto>();
            do {
// Read the values of a row in the table using the indexes acquired above
                manufacturerdto _manufacturerdto = new manufacturerdto();
...
// If moveToFirst() returns false then cursor is empty
            if (!cursor.moveToFirst()) {
                return new ArrayList<pestinsecticidedto>();
            }
            final List<pestinsecticidedto> pestinsecticidedtos = new ArrayList<pestinsecticidedto>();
            do {
// Read the values of a row in the table using the indexes acquired above
                pestinsecticidedto _pestinsecticidedto = new pestinsecticidedto();
...
// If moveToFirst() returns false then cursor is empty
            if (!cursor.moveToFirst()) {
                return new ArrayList<settingdto>();
            }
            final List<settingdto> settingdtos = new ArrayList<settingdto>();
            do {
// Read the values of a row in the table using the indexes acquired above
                settingdto _settingdto = new settingdto();
...
// close the database
    ...
    public List<search_crop_dto> getcropsvarietiesgivencropname(String searchTerm) {
        try {
            ...
            List<search_crop_dto> _lstsearchdtos = new ArrayList<search_crop_dto>();
            List<cropdto> _filtercrops = new ArrayList<cropdto>();
    ...
    public List<search_cropdiseasepest_dto> getpesticidesinsecticidesgivendiseasepestname(String searchTerm) {
        try {
            ...
            List<search_cropdiseasepest_dto> _lstsearchdtos = new ArrayList<search_cropdiseasepest_dto>();
