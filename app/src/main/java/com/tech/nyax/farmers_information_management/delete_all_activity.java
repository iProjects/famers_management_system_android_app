...
//            _progressapisingleton.showProgress(getApplicationContext(), getApplicationContext().getResources().getString(R.string.editcropprogress), true);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                if ("crops".equals(_dto_entity_type)) {
                ...
                } else if ("cropsvarieties".equals(_dto_entity_type)) {
                ...
                } else if ("diseasespests".equals(_dto_entity_type)) {
                ...
                } else if ("manufacturers".equals(_dto_entity_type)) {
                ...
                } else if ("pestsinsecticides".equals(_dto_entity_type)) {
                ...
                } else if ("settings".equals(_dto_entity_type)) {
                ...
                } else if ("categories".equals(_dto_entity_type)) {
